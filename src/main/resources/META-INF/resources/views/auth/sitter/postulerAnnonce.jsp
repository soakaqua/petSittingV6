...
<body>
	...
	<div id="corps" class="row">
		...
		<div id="textePrincipal" class="col-8">
			...
			<form:form action="${ctx}/sitter/postulerAnnonce" method="post"
				modelAttribute="reponseAnnonce">
      ...
      reponseAnnonce : l'objet à poster , dans notre cas l'objet est une annonce --%>
				...
				<div class="form-group">
					...
					<form:select path="numA">
						<!-- nom de l'attribut numA dans l'annonce -->

						<form:options items="${listAnnonces}" itemValue="numA"
							itemLabel="titre" />
					</form:select>
